...
<html lang="en">
  <head>
    ...
    <title>Company view job post</title>
                  ...
                  while($row = $result->fetch_assoc()) 
                  {
                   ?>
                    <tr>
                      ...
                      <td><a href="edit-job-post.php?id=<?php echo $row['id_jobpost']; ?>">Edit</a> <a href="delete-job-post.php?id=<?php echo $row['id_jobpost']; ?>" onclick="return confirm('Are you sure?')">Delete</a></td>
                    </tr>
                   <?php
                 }
               }
