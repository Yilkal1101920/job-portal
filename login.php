          ...
          <h2 class="text-center">Login</h2>
            <form method="post" action="checklogin.php">
              ...
              if(isset($_SESSION['registerCompleted'])) {
                ?>
                <div>
                  <p id="successMessage" class="text-center" style="color:lightblue"><b>Registeration Complete!</b></p>
                </div>
              <?php
              ...
              if(isset($_SESSION['loginError'])) {
                ?>
                <div>
                  <p class="text-center" style="color:red">Invalid Email/Password! Please Try Again!</p>
                </div>
              <?php
