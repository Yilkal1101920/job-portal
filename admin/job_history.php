      ...
      <div class="row">
        <div class="col-md-4">
          <div class="list-group">
            ...
            <a href="company_history.php" class="list-group-item ">Company</a>
            <a href="job_history.php" class="list-group-item active">Job Posts</a>
          </div>
        </div>
        <div class="col-md-6">
          <div class="col-md-6">
