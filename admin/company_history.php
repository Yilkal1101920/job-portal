      ...
      <div class="row">
        <div class="col-md-4">
          <div class="list-group">
            <a href="user_history.php" class="list-group-item">Users</a>
            <a href="company_history.php" class="list-group-item active">Company</a>
            <a href="job_history.php" class="list-group-item">Job Posts</a>
          </div>
        </div>
        <div class="col-md-6">
          <div class="col-md-6">
        <?php
          $sql = "SELECT * FROM company_history";
