  ...
  <body>
        ...
        <div class="container-fluid">
          ...
          <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">     
            <ul class="nav navbar-nav navbar-right">
              <li><a href="./rejected_company.php">Rejected_Companies</a></li>
    ...
    <div class="container-fluid">
      <div class="row">
        ...
        <div class="col-md-6">
        <?php
          $sql = "SELECT * FROM company WHERE active='2'";  // active = 2 indicates waiting for approval
                  ...
                  while($row = $result->fetch_assoc()) {
                    ?>
                      <tr>
                        ...
                        <td><a href="reject-company.php?id=<?php echo $row['id_company']; ?>" onclick="return confirm('Are you sure?')">Reject</a> <a href="approve-company.php?id=<?php echo $row['id_company']; ?>" onclick="return confirm('Are you sure?')">Approve</a></td>
                      </tr>
                    <?php
                  }
                }
