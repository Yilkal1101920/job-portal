        ...
        <div class="row">
          <div class="col-md-12">
            <div class="jumbotron text-center">
              ...
              <p><a class="btn btn-primary btn-lg" href="register.php" role="button">Register (Job Seeker)</a></p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-4 col-md-offset-4 well">
            ...
            <p class="text-center">Register your company and advertise available jobs in our website.</p>
            <div class="pull-left">
